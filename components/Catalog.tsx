        ...
        <div className="w-2/3 bg-cream-200 dark:bg-nightBg-800 flex flex-col overflow-hidden relative transition-colors duration-300">
          ...
          {selectedDataset ? (
            <div className="flex flex-col h-full overflow-y-auto custom-scrollbar">
              ...
              <div className="p-6 border-b border-cream-300 dark:border-white/10 bg-cream-100/50 dark:bg-bloom-card/50">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    {/* Map Toggle Button */}
                    {(selectedDataset.geojsonUrl || selectedDataset.arcGisEmbedUrl) && selectedDataset.viewerType !== 'none' ? (
                      <button 
              ...
              {/* Map Preview Module */}
              {showMap && (selectedDataset.geojsonUrl || selectedDataset.arcGisEmbedUrl) && selectedDataset.viewerType !== 'none' && (
