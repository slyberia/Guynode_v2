...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  tutorial:   'bg-gn-accent-blue/10 text-gn-accent-blue dark:bg-gn-accent-blue/10 dark:text-gn-accent-blue border-gn-accent-blue/20 dark:border-gn-accent-blue/20',
  ...
  comparison: 'bg-guyana-red/10 text-guyana-red dark:bg-guyana-red/10 dark:text-guyana-red border-guyana-red/20 dark:border-guyana-red/20',
};

const DIFFICULTY_COLORS: Record<string, string> = {
  beginner:     'bg-guyana-green/10 text-guyana-green dark:bg-guyana-green/10 dark:text-guyana-green border-guyana-green/20 dark:border-guyana-green/20',
